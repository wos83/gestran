...
type
   TFrmReportCenario2 = class(TForm)
      bndCabecalho: TRLBand;
      bndColunas: TRLBand;
      bndDetalhes: TRLBand;
      bndGrupoVendedor: TRLGroup;
      bndRodape: TRLBand;
      bndSumario: TRLBand;
      drwLinha: TRLDraw;
      imgLogo: TRLImage;
      ...
      RLReportCenario2: TRLReport;

      procedure FormCreate(Sender: TObject);
      procedure lblTotalComissaoBeforePrint(Sender: TObject; var AText: string; var PrintIt: Boolean);
   private
...
var
   FrmReportCenario2: TFrmReportCenario2;
...
procedure TFrmReportCenario2.ConfigurarComponentes;
var
   LInt: integer;
begin
   ...
   RLPDFFilter.DocumentInfo.Title := 'GESTRAN - Relatório de Vendas (Cenário 2)';
...
procedure TFrmReportCenario2.FormCreate(Sender: TObject);
const
   maskValue = ',.00';
begin
   ...
   bndGrupoVendedor.DataFields := 'Vendedor';
end;

procedure TFrmReportCenario2.lblTotalComissaoBeforePrint(Sender: TObject; var AText: string; var PrintIt: Boolean);
var
   LVendedor: string;
begin
   LVendedor := lblVendedor.DataSource.DataSet.FindField('Vendedor').AsString;
   lblTotalComissao.DataSource.DataSet.Locate('Vendedor', LVendedor, []);
end;
